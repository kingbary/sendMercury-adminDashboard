...
export default function MobileTable({ status, orderData }) {
            ...
            {orderData.map((order, index) => {
              return (
                ...
                >
                  ...
                  >
                    <div className="flex gap-1 items-center">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-midGrey">{order?.vendor}</p>
                      </div>
                    </div>
                  ...
                  >
                    <div>
                      <p className="font-semibold center">Product Store ID</p>
                      <p>{order?.address}</p>
                    </div>
                  </div>
                  <Button
